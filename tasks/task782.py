'''
Задача 782
Различные ряды и столбцы

Сложность двоичной матрицы $n\times n$ - это количество различных рядов и столбцов в ней.

Например, рассмотрим матрицы $3\times 3$
$$		\mathbf{A} = \begin{pmatrix} 1&0&1\\0&0&0\\1&0&1\end{pmatrix}	\quad
		\mathbf{B} = \begin{pmatrix} 0&0&0\\0&0&0\\1&1&1\end{pmatrix}	$$
$\mathbf{A}$ имеет сложность 2, так как множество рядов и столбцов равно $\{000,101\}$.
$\mathbf{B}$ имеет сложность 3, так как множество рядов и столбцов равно $\{000,001,111\}$.
