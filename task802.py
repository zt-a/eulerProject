...
Пусть $P(n)$ обозначает сумму $x$ координат всех точек, чей период не превышает $n$.
Любопытно, что $P(n)$ - всегда целое число. Например, $P(1) = 2$, $P(2) = 2$, $P(3) = 4$.
